...
#ifndef NFD_DAEMON_FW_CLOSER_SITE_STRATEGY_HPP
#define NFD_DAEMON_FW_CLOSER_SITE_STRATEGY_HPP
 ...
 */
class CloserSiteStrategy : public Strategy
{
public:
  CloserSiteStrategy(Forwarder& forwarder, const Name& name = STRATEGY_NAME);
